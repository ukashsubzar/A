...
async function main() {
  const contract = await hre.ethers.deployContract("Swisstronik", ["Hello Swisstronik from techearningsupport!!"]);
...
async function main() {
  ...
  const messageToSet = "Hello Swisstronik from techearningsupport!!";
...
echo "Done! Subscribe: https://t.me/techearningsupport"#!/bin/sh
